...
3. Set up the environment variables. Create a `.env` file in the root directory and add the following variables:
   ...
   CLOUDINARY_CLOUD_NAME=deiiy8ytx
   CLOUDINARY_API_KEY=743652548912863
   CLOUDINARY_API_SECRET=W8zmzNdod7sSvaU6lgEPdiSn7Ds
   CLOUDINARY_CLOUDINARY_URL=cloudinary://743652548912863:W8zmzNdod7sSvaU6lgEPdiSn7Ds@deiiy8ytx
   ```
